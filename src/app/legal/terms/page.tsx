    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="mx-auto max-w-4xl px-4 pb-16 pt-10 space-y-4">
        ...
        <div className="space-y-3 text-slate-200 text-sm leading-relaxed">
          <p>BarPulse provides a platform for bar owners to publish offerings and for patrons to discover bars. By using the service, you agree to comply with applicable laws and not post illegal or abusive content.</p>
