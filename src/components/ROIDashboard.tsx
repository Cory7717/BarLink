...
export default function ROIDashboard({ barId }: { barId: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ROI Highlight */}
      <div className="rounded-2xl border border-emerald-500/50 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 backdrop-blur-md p-8 shadow-lg text-center">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="h-12 rounded-lg bg-slate-800 overflow-hidden">
              <div className="h-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center text-white text-sm font-semibold" style={{ width: '100%' }}>
                100%
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="h-12 rounded-lg bg-slate-800 overflow-hidden">
              <div className="h-full bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center text-white text-sm font-semibold" style={{ width: `${metrics.clickThroughRate * 100}%` }}>
          ...
          <div>
            ...
            <div className="h-12 rounded-lg bg-slate-800 overflow-hidden">
              <div className="h-full bg-gradient-to-r from-emerald-500 to-emerald-600 flex items-center justify-center text-white text-sm font-semibold" style={{ width: `${metrics.overallConversionRate * 100}%` }}>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 backdrop-blur-md p-4">
        ...
        <div className="rounded-xl border border-blue-500/30 bg-gradient-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-md p-4">
        ...
        <div className="rounded-xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-purple-600/5 backdrop-blur-md p-4">
        ...
        <div className="rounded-xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-amber-600/5 backdrop-blur-md p-4">
      ...
      <div className="rounded-2xl border border-slate-700/50 bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-md p-6 shadow-lg">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-lg border border-emerald-500/20 bg-gradient-to-r from-emerald-500/5 to-transparent p-4">
          ...
          <div className="rounded-lg border border-blue-500/20 bg-gradient-to-r from-blue-500/5 to-transparent p-4">
          ...
          <div className="rounded-lg border border-purple-500/20 bg-gradient-to-r from-purple-500/5 to-transparent p-4">
            <div className="text-2xl mb-2">✋</div>
              ...
              return (
                <div key={day.dayOfWeek} className="text-center">
                  ...
                  <div className="relative h-24 bg-slate-800 rounded-lg overflow-hidden flex flex-col justify-end">
                    <div
                      className="bg-gradient-to-t from-emerald-500 to-emerald-600"
