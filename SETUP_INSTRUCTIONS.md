# BarLink360 Setup Instructions

## Overview
BarLink360 is a real-time bar discovery platform with owner subscriptions (PayPal), map search (Mapbox), media storage (AWS S3), and auth (NextAuth + Google OAuth).
...
```bash
# Database (Neon)
DATABASE_URL="postgresql://user:password@your-neon-host.neon.tech:5432/BarLink360?sslmode=require"
...
AWS_S3_BUCKET="BarLink360-media"
AWS_S3_PUBLIC_BASE_URL="https://BarLink360-media.s3.amazonaws.com"

# Email (choose SendGrid OR SMTP)
SENDGRID_API_KEY="SG.xxx"
EMAIL_FROM="BarLink360 <no-reply@BarLink360.com>"
# OR SMTP:
# SMTP_HOST="smtp.gmail.com"
# SMTP_PORT="587"
# SMTP_USER="your-email@gmail.com"
# SMTP_PASSWORD="your-app-password"
# SMTP_FROM="BarLink360 <no-reply@BarLink360.com>"
